<%@ Page Title="" Language="C#" MasterPageFile="main.master" AutoEventWireup="true" CodeFile="EmpSalaryGenerate.aspx.cs" Inherits="EmailSetting" %>
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-sm-12 " style="padding-bottom: 20px;">
                ...
                <div class="col-md-6">
                    <asp:Button ID="btn_submit" CssClass="btn btn-payroll pull-right" OnClick="btnEmploySalaryGenClick" runat="server" Text="Employee Salary Generate" />
                </div>
            </div>
        </div>
                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="100%" Width="100%"
                                ...
                                <LocalReport ReportPath="Report\SalaryGenReport.rdlc">
                                    <DataSources>
                            ...
                            <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:vt_EMSConnectionString %>' SelectCommand="VT_SP_GetEmpSalaries" SelectCommandType="StoredProcedure">
                                <SelectParameters>
