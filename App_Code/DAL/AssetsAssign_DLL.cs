...
/// </summary>
public class AssetsAssign_DLL
{
    public AssetsAssign_DLL()
    {
        //
    ...
    public virtual DataTable getAssignAssets()
    {
        try
        {
            return SqlHelper.ExecuteDataset(vt_Common.PayRollConnectionString, CommandType.StoredProcedure, "Sp_Get_AssignedAssets").Tables[0];
        }
        catch (Exception ex)
        {
            ErrHandler.TryCatchException(ex);
    ...
    public virtual DataTable getgratuity()
    {
        try
        {
            return SqlHelper.ExecuteDataset(vt_Common.PayRollConnectionString, CommandType.StoredProcedure, "Sp_GetGraduity").Tables[0];
        }
        catch (Exception ex)
        {
            ErrHandler.TryCatchException(ex);
