<%@ Page Title="" Language="C#" MasterPageFile="~/NewMain.master" AutoEventWireup="true" CodeFile="EmployeeFineCharges.aspx.cs" Inherits="EmployeeFineCharges" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <section class="content-header">
        <h1 style="margin-top:20px;">Employee Fine/Charges</h1>
        <ol class="breadcrumb">
      ...
      <div class="row">
        <div class="col-sm-12 " style="padding-bottom: 20px;">
            ...
            <asp:UpdatePanel runat="server" ID="UpAddNew">
                <ContentTemplate>
                    <asp:Button ID="BtnAddNew" runat="server" CssClass="btn btn-payroll pull-right mylinks" Text="Add New" OnClick="BtnAddNew_Click" 
            ...
            <div class="col-md-12">
                <div class="box box-info custom_input">
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title">Employee Fine/Charges Details</h3>
                    </div>
                    <div class="box-body">
                        <div class="table-responsive">
                            <asp:UpdatePanel ID="UpView" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:GridView ID="grdempfinecharges" runat="server"  CssClass="table table-bordered table-hover" AutoGenerateColumns="False" >
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="FineCharges"  HeaderText="Fine Charges" HeaderStyle-Width="20%" />
                                            <asp:BoundField DataField="Description"    HeaderText="Description" HeaderStyle-Width="20%" />                                            
    ...
    <div class="modal fade" id="EmpFineChargesForm" role="dialog" aria-labelledby="myModalLabel" data-keyboard="false" data-backdrop="static">
                    ...
                    <ContentTemplate>
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="myModalLabel">Create Fine/Charges</h4>
                            </div>
                            <div class="modal-body">
                                <table class="all-table all-tables">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                              <asp:DropDownList ID="ddlEmployee" ClientIDMode="Static" enabled="true"  CssClass="form-control input-sm" runat="server" validate='vgroup'  require='Please Select Employee' AutoPostBack="true" AppendDataBoundItems="True" >
                                                    </asp:DropDownList>
                                    ...
                                    <tr>
                                        <td>
                                            <label>FineCharges</label>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtfinecharges" type="number" runat="server" validate='vgroup' require='Please enter price' CssClass="form-control"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtdescription" type="text" runat="server" validate='vgroup' require='Please enter detail' CssClass="form-control"></asp:TextBox>
                            ...
                            <div class="modal-footer">
                                <asp:Button ID="btnSave" runat="server" class="btn btn-payroll" OnClick="btnSave_Click" OnClientClick="return Saveonclick();" Text="Save Changes"  CausesValidation="true"></asp:Button>
