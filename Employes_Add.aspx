<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="Employes_Add.aspx.cs" Inherits="Employes_Add" %>
                                                    ...
                                                    <div class="col-md-12" id="mybtn">
                                                            ...
                                                            <div id="divgeneraldetails" class="new_emp_form">
                                                                ...
                                                                <div class="row labels">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <ajaxToolkit:MaskedEditExtender ID="Mask1" runat="server" TargetControlID="txtPhone" Mask="999-99999999"
                                                                            MessageValidatorTip="true" 
                                                                            OnFocusCssClass="MaskedEditFocus" 
                                                                            OnInvalidCssClass="MaskedEditError"
                                                                            MaskType="Number" 
                                                                        ...
                                                                        <asp:TextBox ID="TxtMobile" validate='vgroup' require="Please Select" onkeypress="return isNumberKey(event);" CssClass="form-control" runat="server"></asp:TextBox>
                                                                        <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender2" runat="server" TargetControlID="TxtMobile" Mask="9999-9999999"
                                                                            MessageValidatorTip="true" 
                                                                            OnFocusCssClass="MaskedEditFocus" 
                                                                            OnInvalidCssClass="MaskedEditError"
                                                                            MaskType="Number" 
                                                                        ...
                                                                        <div id="MarriedShow">
                                                                            <label class="col-sm-6 control-label">Wed Aniversary:</label>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <label class="control-label pull-left">Address Line 2:</label>
                                                                        <asp:TextBox ID="TxtCurrent_Address2" runat="server" CssClass="emp-address form-control" Placeholder="Enter Address 2"></asp:TextBox>
                                                                    </div>
                                                                    <div class="col-sm-12">
                                                                        <label class="control-label pull-left">Address Line 3:</label>
                                                                        <asp:TextBox ID="TxtCurrent_Address3" runat="server" CssClass="emp-address form-control" Placeholder="Enter Address 3"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-sm-3">
                                                                ...
                                                                <h3 class="mt-40 text-left mb-0">Permenant Address</h3>
                                                                <input type="checkbox" value="Permenant Address is different" class="mb-10 float-left" style="width:20px;" onchange="SameAddress(this)"/> <span class="float-left">Same as above</span>
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        <label class="control-label pull-left">Address Line 1:</label>
                                                                        <asp:TextBox ID="TxtPermenant_Address1" runat="server" CssClass="emp-address form-control" ReadOnly="false" Placeholder="Enter Address 1"></asp:TextBox>
                                                                    </div>
                                                                    <div class="col-sm-12">
                                                                        <label class="control-label pull-left">Address Line 2:</label>
                                                                        <asp:TextBox ID="TxtPermenant_Address2" runat="server" CssClass="emp-address form-control" ReadOnly="false" Placeholder="Enter Address 2" ></asp:TextBox>
                                                                    </div>
                                                                    <div class="col-sm-12">
                                                                        <label class="control-label pull-left">Address Line 3:</label>
                                                                        <asp:TextBox ID="TxtPermenant_Address3" runat="server" CssClass="emp-address form-control" ReadOnly="false" Placeholder="Enter Address 3" ></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-sm-3">
                                                                        <label class="control-label pull-left">City:</label>
                                                                        <asp:TextBox ID="TxtPermenant_City" runat="server" CssClass="emp-address form-control" ReadOnly="false" Placeholder="Enter City"></asp:TextBox>
                                                                    </div>
                                                                    <div class="col-sm-3">
                                                                        <label class="control-label pull-left">State/Region:</label>
                                                                        <asp:TextBox ID="TxtPermenant_State" runat="server" CssClass="emp-address form-control" ReadOnly="false" Placeholder="Enter State/Region"></asp:TextBox>
                                                                    </div>
                                                                    <div class="col-sm-3">
                                                                        <label class="control-label pull-left">Zip/Postal Code:</label>
                                                                        <asp:TextBox ID="TxtPermenant_Zip" runat="server" CssClass="emp-address form-control" ReadOnly="false" Placeholder="Enter Zip/Postal Code"></asp:TextBox>
                                                                    </div>
                                                                    <div class="col-sm-3">
                                                                        <label class="control-label pull-left">Country:</label>
                                                                        <asp:TextBox ID="TxtPermenant_Country" runat="server" CssClass="emp-address form-control" ReadOnly="false" Placeholder="Enter Country"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                                <div class="row" runat="server" visible="false">
                                                                    ...
                                                                    <div class="col-sm-12"  runat="server">
                                                                        ...
                                                                        <asp:TextBox ID="txtParmanantAddress" require="Please Select" runat="server" TextMode="MultiLine" Rows="7" CssClass="emp-address form-control"></asp:TextBox>
                                                                        ...
                                                                        <div class="form-group text-left cstm-form-group">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="choose-file mb-10">
                                                                                    ...
                                                                                    <asp:Label ID="LblResumeUpload" runat="server" class="control-label"></asp:Label>
                                                                                    <asp:Label ID="txtCV" runat="server" Text="Attach Resume" CssClass="emp-address"></asp:Label>
                                                                                ...
                                                                                <div class="choose-file mb-10">
                                                                                    <asp:HiddenField ID="hdnRearName" runat="server" />
                                                                                    <asp:HiddenField ID="hdnRearImage" runat="server" />
                                                                                    <asp:Label ID="lblRearNIC" runat="server" class="control-label"></asp:Label>
                                                                                    <asp:Label ID="txtRearNIC" runat="server" Text="Attach Rear NIC"></asp:Label>
                                                                                    <asp:FileUpload ID="RearImageUpload" runat="server" />
                                                                                </div>
                                                                                <div class="choose-file mb-10">
                                                                                    <asp:HiddenField ID="hdpasportname" runat="server" />
                                                                                    <asp:HiddenField ID="hdPasportImage" runat="server" />
                                                                                    <asp:Label ID="lblpasport" runat="server" class="control-label"></asp:Label>
                                                                                    <asp:Label ID="txtpassport" runat="server" Text="Attach Passport"></asp:Label>
                                                                                    <asp:FileUpload ID="PassportUpload" runat="server" />
                                                                                </div>

                                                                                <div class="choose-file mb-10">
                                                                                    <asp:HiddenField ID="hddocumenstupload" runat="server" />
                                                                                    <asp:Label ID="lbldocuments" runat="server" class="control-label"></asp:Label>
                                                                                    <asp:Label ID="txtdocuments" runat="server" Text="Attach Documents"></asp:Label>
                                                                                    <asp:FileUpload ID="documentsupload" runat="server" />
                                                                                </div>

                                                                                <div class="choose-file mb-10">
                                                                                    <asp:HiddenField ID="hdotherdocumntsupload" runat="server" />
                                                                                    <asp:Label ID="lblotherdocuments" runat="server" class="control-label"></asp:Label>
                                                                                    <asp:Label ID="txtothers" runat="server" Text="Attach Others Documents"></asp:Label>
                                                        ...
                                                        <fieldset>
                                                            ...
                                                            <div class="row cstm-align-labels">
                                                                <div class="col-md-6">
                                                                    <asp:RadioButton ID="rdoProb" runat="server" Checked="true" CssClass="col-sm-6" GroupName="rdoConf_Pro" Text="Pro: Period" />
                                                                    <asp:RadioButton ID="rdoConfirmation" runat="server" CssClass="col-sm-6" GroupName="rdoConf_Pro" Text="Conf: Date" />
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div id="Prov" runat="server" style="display: none">
                                                                        <label class="col-sm-12 control-label">
                                                                        Probation Period (No of Months):</label>
                                                                        <asp:TextBox ID="txtProbationPeriod" runat="server" class="is-number" CssClass="form-control"></asp:TextBox>
                                                                    </div>
                                                                    <div id="Conf" runat="server" style="display: none;">
                                                                        <label class="col-sm-12 control-label">
                                                                        Confr. Date:</label>
                                                                        <div id="dtConfrDate">
                                                                            <asp:TextBox ID="txtConfrDate" runat="server" autocomplete="off" ClientIDMode="Static" CssClass="form-control"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                    <label class="col-sm-12 control-label ">
                                                                    Joining Date:</label>
                                                                    ...
                                                                    <div style="display: none">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            ...
                                                                            <asp:DropDownList ID="ddlShift" runat="server" AppendDataBoundItems="true" AutoPostBack="true" custom="Please Select Shift" DataSourceID="EDS_Shift" DataTextField="ShiftShortName" DataValueField="ShiftID">
                                                                                <asp:ListItem Text="Please Select Shift..." Value="0"></asp:ListItem>
                                                                            </asp:DropDownList>
                                                            ...
                                                            <div id="divpayrollsetting" class="form-horizontal">
                                                                ...
                                                                <div class="row cstm-align-labels">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <label class="col-sm-12 ">Fuel Allowance</label>
                                                                        ...
                                                                        <label class="col-sm-12 control-label">Type Of Provident Fund</label>
                                                                        <asp:DropDownList ID="ddPFtype" class="form-control" runat="server" validate='vgroup' require="Please Enter">
                                                                            <asp:ListItem Value="0" Text="Please Select"></asp:ListItem>
                                                                        </asp:DropDownList>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <label class="col-sm-12">House Rent Allowance</label>
                                                                        ...
                                                                        <label class="col-sm-12 ">Special Allowance</label>
                                                                        ...
                                                                        <label class="col-sm-6 ">Provident Fund</label>
                                                                        <asp:CheckBox ID="ChkBxProvidentFund" runat="server" />
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                       
                                                                        <label class="col-sm-12 ">IsGratuity</label>
                                                                        <asp:CheckBox ID="ChkGraduity" runat="server" />
                                                                    </div>
                                                                </div>
     ...
     <script type="text/javascript">
        ...
        function SameAddress(isChecked) {
            if (isChecked.checked) {
                ...
                $("#<%=TxtPermenant_Address1.ClientID%>").val($("#<%=TxtCurrent_Address1.ClientID%>").val());
                $("#<%=TxtPermenant_Address2.ClientID%>").val($("#<%=TxtCurrent_Address2.ClientID%>").val());
                $("#<%=TxtPermenant_Address3.ClientID%>").val($("#<%=TxtCurrent_Address3.ClientID%>").val());
                $("#<%=TxtPermenant_City.ClientID%>").val($("#<%=TxtCurrent_City.ClientID%>").val());
                $("#<%=TxtPermenant_State.ClientID%>").val($("#<%=TxtCurrent_State.ClientID%>").val());
                $("#<%=TxtPermenant_Zip.ClientID%>").val($("#<%=TxtCurrent_Zip.ClientID%>").val());
                $("#<%=TxtPermenant_Country.ClientID%>").val($("#<%=TxtCurrent_Country.ClientID%>").val());

                $('#<%=TxtPermenant_Address1.ClientID%>').prop('readonly', true);
                $('#<%=TxtPermenant_Address2.ClientID%>').prop('readonly', true);
                $('#<%=TxtPermenant_Address3.ClientID%>').prop('readonly', true);
                $('#<%=TxtPermenant_City.ClientID%>').prop('readonly', true);
                $('#<%=TxtPermenant_State.ClientID%>').prop('readonly', true);
                $('#<%=TxtPermenant_Zip.ClientID%>').prop('readonly', true);
                $('#<%=TxtPermenant_Country.ClientID%>').prop('readonly', true);
            }
            else {

                $("#<%=TxtPermenant_Address1.ClientID%>").val('');
                $("#<%=TxtPermenant_Address2.ClientID%>").val('');
                $("#<%=TxtPermenant_Address3.ClientID%>").val('');
                $("#<%=TxtPermenant_City.ClientID%>").val('');
                $("#<%=TxtPermenant_State.ClientID%>").val('');
                $("#<%=TxtPermenant_Zip.ClientID%>").val('');
                $("#<%=TxtPermenant_Country.ClientID%>").val('');
                
                $('#<%=TxtPermenant_Address1.ClientID%>').prop('readonly', false);
                $('#<%=TxtPermenant_Address2.ClientID%>').prop('readonly', false);
                $('#<%=TxtPermenant_Address3.ClientID%>').prop('readonly', false);
                $('#<%=TxtPermenant_City.ClientID%>').prop('readonly', false);
                $('#<%=TxtPermenant_State.ClientID%>').prop('readonly', false);
                $('#<%=TxtPermenant_Zip.ClientID%>').prop('readonly', false);
                $('#<%=TxtPermenant_Country.ClientID%>').prop('readonly', false);
