...
{ 
    ...
    public override System.Data.DataTable SetDefaultPassword(User_BAL user)
    {
        return base.SetDefaultPassword(user);
    }
    ...
    public override DataTable Getuploadeddocuments(int CompanyID, int emp)
    {

        return base.Getuploadeddocuments(CompanyID,  emp);
    }

    public DataTable PermissionTable = new DataTable();
    public DataTable MenuTable = new DataTable();
    public int UserID { get; set; }
    public int EmployeIeD { get; set; }
