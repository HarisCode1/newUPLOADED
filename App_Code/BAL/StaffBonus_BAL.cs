...
/// </summary>
public class StaffBonus_BAL : StaffBonus_DAL
{
    public StaffBonus_BAL()
    {
        //
    ...
    public override DataTable CreateSP(StaffBonus_BAL BAL)
    {
        return base.CreateSP(BAL);
    }
    public override DataTable UpdateSP(StaffBonus_BAL BAL)
    {
    ...
    public override StaffBonus_BAL GetBonusByID(int id)
    {
