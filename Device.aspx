<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="Device.aspx.cs" Inherits="Device" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   ...
   <div class="row">
    ...
    <div class="modal fade" id="device" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" >
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <asp:DropDownList ID="ddlDevCompany" CssClass="form-control" runat="server">
                                            ...
                                            <asp:ListItem>BioAccessV2</asp:ListItem>
                                            <asp:ListItem>RTLDownloader</asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <asp:TextBox ID="txtName" runat="server" CssClass="form-control" validate='vgroup' require='Please enter a device name'></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <label>Device IP :</label></td>
                                    <td colspan="3">
                                        <asp:TextBox ID="txtIP" runat="server" CssClass="form-control" validate='vgroup' require='Please enter a device IP'></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <label>Port :</label></td>
                                    <td>
                                        <asp:TextBox ID="txtPort" runat="server" CssClass="form-control" validate='vgroup' require='Please enter a port'></asp:TextBox>
                                    </td>
                                    <td style="width: 100px;">
                                        <label class="dev-machinelabel">Machine No :</label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtMachine" runat="server" CssClass="form-control" Text="" validate='vgroup' require='Please enter a machine no'></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td colspan="3">
                                        <asp:DropDownList ID="ddlType" runat="server" CssClass="form-control">
                                            <asp:ListItem>BlackAndWhite</asp:ListItem>
                                            <asp:ListItem>Color</asp:ListItem>
                                            <asp:ListItem>BlackAndWhiteUSB</asp:ListItem>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <asp:UpdatePanel ID="UpView" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <asp:GridView ID="grdDevice" runat="server"  CssClass="table table-bordered table-hover" AutoGenerateColumns="False" OnRowCommand="grdDevice_RowCommand">
                        <Columns>
                            <asp:TemplateField HeaderText="Name">
                                <ItemTemplate>
                                    <asp:Label ID="lblName" runat="server" Text='<%#Eval("DeviceName")%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Action">
                                <HeaderStyle Width="5%" />
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkEdit" runat="server" CommandArgument='<%#Eval("DeviceID")%>' CommandName="EditCompany">
                                <i class="fa fa-pencil-square-o"></i>
                                    </asp:LinkButton>
                                    &nbsp;                        
                            <asp:LinkButton ID="lnkDelete" runat="server" CssClass="confirm" CommandArgument='<%#Eval("DeviceID")%>' CommandName="DeleteCompany" OnClientClick="return confirm('Are you Sure you want to Delete?')">
                    ...
                    <asp:EntityDataSource ID="EDS_Device" runat="server"
                        ConnectionString="name=vt_EMSEntities"
                        DefaultContainerName="vt_EMSEntities" EntitySetName="vt_tbl_Device"
    ...
    <script type="text/javascript">
        ...
        function binddata() {
            $("[id$=grdDevice]").prepend($("<thead></thead>").append($("[id$=grdDevice]").find("tr:first"))).dataTable();
        }
    </script>
